...
tellraw @a ["",{"text":"[","color":"dark_gray"},{"text":"→","color":"#9FFFFF"},{"text":"] ","color":"dark_gray"},{"text":"The snow has begun rising!","color":"#9FFFFF"}]
# sfx
...
# world
schedule function snowrising:system/border/main 130s