...
# rise height limit
tellraw @s ["",{"text":"Rise height limit \u0020 \u0020","hoverEvent":{"action":"show_text","contents":[{"text":"The maximum height limit the lava can reach."}]}},{"text":" ","color":"white"},{"text":"-","color":"red","bold":true,"clickEvent":{"action":"run_command","value":"/function snowrising:setup/rise_height_limit/down"}},{"text":"  ","color":"white"},{"score":{"name":"rise_height_limit","objective":"global"}},{"text":"  ","color":"dark_gray"},{"text":"+","color":"green","bold":true,"clickEvent":{"action":"run_command","value":"/function snowrising:setup/rise_height_limit/up"}},{"text":" ","color":"dark_gray"}]

# rise ticks
tellraw @s ["",{"text":"Rise ticks \u0020 \u0020","hoverEvent":{"action":"show_text","contents":[{"text":"The interval between the lava rising (in ticks)."}]}},{"text":" ","color":"white"},{"text":"-","color":"red","bold":true,"clickEvent":{"action":"run_command","value":"/function snowrising:setup/rise_ticks/down"}},{"text":"  ","color":"white"},{"score":{"name":"rise_ticks","objective":"global"}},{"text":"  ","color":"dark_gray"},{"text":"+","color":"green","bold":true,"clickEvent":{"action":"run_command","value":"/function snowrising:setup/rise_ticks/up"}},{"text":" ","color":"dark_gray"}]
